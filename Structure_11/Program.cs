...
namespace Structure_11
{
   internal class Program
   {
      static void Main()
      {
         // Создание экземпляра класса Notebook и передача в конструктор 3 параметра
         Notebook notebook1 = new Notebook("DELL", 5420, 422.27);
         // Отображение полей класса
         notebook1.Show();
         // Создание экземпляра класса с помощью пользовательского конструктора и передача в конструктор 2 параметра
